...
- **Always run `git diff HEAD` before planning** to see what has already been implemented. Codex handles implementation; Claude plans. Without checking the diff, you will re-plan work that is already done and give Codex redundant or conflicting instructions.
